...
git branch -M main
git remote add origin https://github.com/<takani-pta-baseball-team>/ourpage.git
...
4. しばらく待つと `https://<takani-pta-baseball-team>.github.io/ourpage/` でアクセス可能
...
4. Repository access: `Only select repositories` → `ourpage` を選択
